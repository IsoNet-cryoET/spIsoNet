...
if __name__=="__main__":  
    ...
    lowres_end_healpix = parse_env("ISONET_LOWRES_END_HEALPIX", "int", 10)
    lowpass = parse_env("ISONET_LOWPASS", "bool", False)
    ...
    if (check_final is True):
        ...
        if limit_resolution < whitening_low and whitening:
            print("whitening")
            execute_whitening(mrc_unfil, mrc_unfil, high_res=limit_resolution, low_res=whitening_low)  
