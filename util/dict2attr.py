...
map_refine_param = ['i','i2','mask_file','gpuID','ncpus','output_dir','limit_res','fsc_file','iterations','epochs','threshold','n_subvolume','crop_size','cube_size','mixed_precision','batch_size','acc_batches','learning_rate','predict_crop_size','cone_sampling_angle','power']
