...
refine_param = [ 'normalize_percentile', 'batch_normalization', 'filter_base', 'unet_depth', 'pool', 'kernel', 'convs_per_depth', 'drop_out','noise_dir', 
                ...
                'select_subtomo_number','remove_intermediate','prefill', 'probability','arch','acc_batches','ncpus']
...
map_refine_param = ['i','i2','mask_file','gpuID','ncpus','output_dir','limit_res','fsc_file','iterations','epochs','threshold','n_subvolume','crop_size','cube_size','mixed_precision','batch_size','acc_batches','learning_rate','predict_crop_size']
